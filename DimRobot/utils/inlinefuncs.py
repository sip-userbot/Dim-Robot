...
from DimRobot import pbot as app 
from DimRobot import arq
from DimRobot.services.keyboard import Ikb
from DimRobot.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from DimRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from DimRobot.services.types import InlineQueryResultCachedDocument
from DimRobot.modules.info import get_chat_info, get_user_info
from DimRobot.modules.music import download_youtube_audio
from DimRobot.utils.functions import test_speedtest
from DimRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    msg = f"""
**[Dim Robot ✨](https://t.me/suportsipuserbot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
