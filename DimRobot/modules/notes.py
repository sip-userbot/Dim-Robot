...
from DimRobot import LOGGER, JOIN_LOGGER, SUPPORT_CHAT, dispatcher, DRAGONS
...
from DimRobot.modules.helper_funcs.chat_status import user_admin, connection_status
from DimRobot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from DimRobot.modules.helper_funcs.msg_types import get_note_type
...
def list_notes(update: Update, context: CallbackContext):
    ...
    if not note_list:
        try:
            ...
            update.effective_message.reply_text("Tidak ada catatan dalam obrolan ini gblok!", quote=False)
