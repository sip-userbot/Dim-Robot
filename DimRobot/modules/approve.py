...
from DimRobot import dispatcher, DRAGONS
from DimRobot.modules.helper_funcs.extraction import extract_user
from telegram.ext import CallbackContext, CallbackQueryHandler
import DimRobot.modules.sql.approve_sql as sql
...
*Admin commands:*
令 /approval*:* Check a user's approval status in this chat.
令 /approve*:* Approve of a user. Locks, blacklists, and antiflood won't apply to them anymore.
令 /unapprove*:* Unapprove of a user. They will now be subject to locks, blacklists, and antiflood again.
令 /approved*:* List all approved users.
