...
import sys
import traceback
import DimRobot.modules.sql.users_sql as sql
from sys import argv
from typing import Optional
from telegram import __version__ as peler
from platform import python_version as memek
from DimRobot import (
    ALLOW_EXCL,
    CERT_PATH,
    DONATION_LINK,
    BOT_USERNAME as bu,
...
from DimRobot.modules import ALL_MODULES
from DimRobot.modules.helper_funcs.chat_status import is_user_admin
from DimRobot.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an DIM management bot [✨](https://telegra.ph/file/64f4b1e3ab6d6911447d2.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Dim Robot", callback_data="Dim_"),
    ],
    [
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @Klyuserbot \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DimRobot.modules." + module_name)
...
def Dim_about_callback(update, context):
    query = update.callback_query
    if query.data == "Dim_":
        query.message.edit_text(
            text="๏ I'm *Dim*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n Click on button bellow to get basic help for DimRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, DimRobot now ready to manage your group."
            "\n\n*Admin Tools*"
    ...
    elif query.data == "Dim_support":
        query.message.edit_text(
            text="*๏ Dim support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Dim.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
        ...
        query.message.edit_text(
            text=f"๏ Credis for Dim\n"
            "\nHere Developers Making And Give Inspiration For Made The DimRobot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Dim_about_callback, pattern=r"Dim_", run_async=True
    )
